...
interface  InputSillsProps {
  // Add your component props here
  form: UseFormReturn<z
    .infer<typeof jobFormSchema>>;
}

const InputSills: FC<InputSillsProps> = ({ form }) => {
